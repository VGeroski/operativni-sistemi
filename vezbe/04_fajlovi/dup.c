/* Program demonstrira citanje sa standardnog ulaza na standardni izlaz
   uz preusmeravanje fajl deskriptora na odgovarajuce fajlove. 
   Prakticno umesto da preko komande linije radimo redirekciju, sada radimo programski. */
...
int main(int argc, char **argv)
{
    ...
    /* Ukoliko je nastala greska u sistemskom pozivu read, obradjuje se. */
    if (n < 0)
        error("read()");
